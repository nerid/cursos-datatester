  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-hornette-bg)] relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md p-8 rounded-2xl glass-effect premium-shadow z-10"
      >
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-lg bg-[var(--color-hornette-primary)] text-black font-bold tracking-wide hover:bg-[var(--color-hornette-primary-hover)] transition-colors mt-4"
          >
            INGRESAR
          </button>
        </form>
        ...
        <button
          ...
          className="w-full mt-6 py-3 rounded-lg bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
        >
